...
public class SubtractFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_subtract,container,false);
        ...
        TextView Result =(TextView) rootView.findViewById(R.id.subtracting);
